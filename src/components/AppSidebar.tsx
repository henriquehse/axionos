import {
  ...
  Brain, FileText, Gauge, FlaskConical, Plug, Activity, ShieldCheck, Sparkles,
  Target, Terminal, User, Zap,
} from "lucide-react";
...
const mainItems = [
  ...
  { title: "Nexus Lab", url: "/neural-lab", icon: Brain },
  { title: "Leads Dashboard", url: "/leads", icon: Target },
...
const bottomItems = [
  ...
  { title: "Traffic Sentinel", url: "/traffic-sentinel", icon: Activity },
...
export function AppSidebar() {
  ...
  const visibleMainItems = mainItems.filter(item => 
    ["Nexus Lab", "Leads Dashboard"].includes(item.title) || isSidebarItemVisible(item.title)
  );
  const visibleBottomItems = bottomItems.filter(item => 
    ["Traffic Sentinel"].includes(item.title) || isSidebarItemVisible(item.title)
  );
